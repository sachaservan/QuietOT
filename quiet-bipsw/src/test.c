...
double benchmarkOTs()
{
    ...
    uint128_t *outputs_sender;
    uint128_t *outputs_receiver;
    posix_memalign((void **)&outputs_sender, 64, num_outputs * 6 * sizeof(uint128_t));
    posix_memalign((void **)&outputs_receiver, 64, num_outputs * sizeof(uint128_t));
